function Get-ChiaRAMInfo {
    <#
        ...
        .DESCRIPTION
            ...
            the amount of installed memory, the RAM manufacturer/part number and RAM device information.
        .PARAMETER c
        ...
        .EXAMPLE
            ...
            This example will immediately display general information about the installed system memory.
        .EXAMPLE
